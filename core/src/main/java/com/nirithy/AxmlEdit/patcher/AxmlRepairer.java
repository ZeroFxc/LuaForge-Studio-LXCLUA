...
public class AxmlRepairer {


    public static byte[] fix(byte[] in) throws IOException {
        AxmlReader reader = new AxmlReader(in);
            ...
            public NodeVisitor child(String ns, String name) {// manifest
                ...
                return new NodeVisitor(nv) {
                    ...
                    public void attr(String ns, String name, int resourceId, int type, Object obj) {
                        ...
                        // obj.toString()));
                        String realName = (-1 == resourceId || AndroidAttrDefs.get(resourceId) == null) ? name : AndroidAttrDefs.get(resourceId).getName();
                        String realNs = null == ns ? null : AndroidAttrDefs.ns;
