package com.nirithy.AxmlEdit;

import com.nirithy.AxmlEdit.patcher.AxmlRepairer;
import com.nirithy.AxmlEdit.core.NodeVisitor;
import com.nirithy.AxmlEdit.core.AxmlReader;
import com.nirithy.AxmlEdit.core.AxmlUtil;
import com.nirithy.AxmlEdit.core.Visitor;
import com.nirithy.AxmlEdit.core.AxmlWriter;
...
public class AxmlEditor {
    ...
    public AxmlEditor(InputStream manifest) throws IOException {
        mManifestData = AxmlUtil.readIs(manifest);
    }
    ...
    public void commit() throws IOException {
        AxmlReader reader = new AxmlReader(mManifestData == null ? AxmlUtil.readFile(mManifest) : mManifestData);
        ...
        mManifestData = usefix ? AxmlRepairer.fix(writer.toByteArray()) : writer.toByteArray();
    }
    ...
    public void fixPermissionNames(String originalPackageName, String newPackageName) {
        ...
        try {
            AxmlReader reader = new AxmlReader(mManifestData);
            AxmlWriter writer = new AxmlWriter();
