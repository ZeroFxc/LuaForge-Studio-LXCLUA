...
public class LanguageLua extends Language {
    ...
    private final static String keywordTarget = "and|break|case|catch|continue|default|defer|delete|do|else|elseif|end|false|finally|for|function|goto|guard|if|in|lambda|local|nil|not|or|repeat|return|switch|then|true|try|until|when|while";
