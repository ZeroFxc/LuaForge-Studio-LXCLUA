package com.luaforge.studio.lxclua.langs.lua
    ...
    companion object {
        ...
        private fun doStaticInit() {
            sKeywords = arrayOf(
                ...
                "ipairs", "pairs","mpairs", "next", "print", "rawequal", "rawget", "rawset", "select",
                "setmetatable", "getmetatable", "tonumber", "tostring", "type", "unpack",
                "lambda", "newClass", "_G", "try", "finally", "catch", "defer", "when", "guard", "delete",
                ...
                "new", "override", "super", "private", "protected", "public", "static",
            ...
            val sTokens = arrayOf(
                ...
                Tokens.REQUIRE, Tokens.SWITCH, Tokens.CONTINUE, Tokens.CASE, Tokens.DEFAULT, Tokens.DELETE,
                Tokens.CALL, Tokens.COLLECTGARBAGE, Tokens.COMPILE, Tokens.COROUTINE,
                Tokens.ASSERT, Tokens.ERROR, Tokens.IPAIRS, Tokens.PAIRS,Tokens.MPAIRS, Tokens.NEXT,
                ...
                Tokens.TRY, Tokens.FINALLY, Tokens.CATCH, Tokens.DEFER, Tokens.WHEN, Tokens.GUARD,
