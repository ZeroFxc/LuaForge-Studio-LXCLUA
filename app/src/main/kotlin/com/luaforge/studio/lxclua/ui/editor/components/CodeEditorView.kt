...
import com.luaforge.studio.lxclua.ui.theme.DropShape
...
fun CodeEditorView(
    ...
    val isDark = when (settingsState.darkMode) {
        com.luaforge.studio.lxclua.ui.settings.DarkMode.FOLLOW_SYSTEM -> systemDark
                        ...
                        Box(
                            ...
                            Row(
                                modifier = Modifier
                                    ...
                                    .padding(start = 16.dp, top = 12.dp, end = 4.dp, bottom = 20.dp),
                                ...
                                IconButton(
                                    onClick = {
                                        clipboardManager.setText(AnnotatedString("Line $line: $message"))
                                    },
